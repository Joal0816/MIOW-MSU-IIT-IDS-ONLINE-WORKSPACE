...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://classsync-guardian.lovable.app/og-cover.jpg" },
      { name: "twitter:image", content: "https://classsync-guardian.lovable.app/og-cover.jpg" },
    ],
  }),
  component: AuthPage,
});
