// Shared Supabase client factory for ClassMate Connect MCP tools.
// Import-safe: only function definitions, no env reads at module top level.
// NEVER reference the service-role key here — MCP tools run as the caller.
